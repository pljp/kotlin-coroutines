...
* [aユースケース](#use-cases)
  * [a非同期計算](#asynchronous-computations)
  * [Futures](#futures)
  * [aジェネレーター](#generators)
  * [a非同期UI](#asynchronous-ui)
  * [aその他のユースケース](#more-use-cases)
* [aコルーチンの概要](#coroutines-overview)
  * [aコルーチンの実験状況](#experimental-status-of-coroutines)
  * [a用語](#terminology)
  * [a継続インタフェース](#continuation-interface)
  * [aサスペンド関数](#suspending-functions)
  * [aコルーチンビルダー](#coroutine-builders)
  * [aコルーチンのコンテキスト](#coroutine-context)
  * [a継続インターセプタ](#continuation-interceptor)
  * [a制限付きサスペンド](#restricted-suspension)
* [その他の例](#more-examples)
